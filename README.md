...
| cursor_color      | string                                                            | `var(--paper-item-icon-color, #44739e)`      | The color of the cursor (circle). Accepts any valid css `background-color` value.                                                                                                                                                                                                                                                                 |
...
| corner_color      | string                                                            | `rgba(0, 0, 0, 0.15)`                        | The background color of the corner buttons. Accepts any valid css `background-color` value.                                                                                                                                                                                                                                                       |
| corner_icon_color | string                                                            | `var(--paper-item-icon-color, #44739e)`      | The color of the corner button icons. Accepts any valid css `color` value.                                                                                                                                                                                                                                                                        |
