...
Take note that for all the [Action](https://www.home-assistant.io/dashboards/actions/) definitions, you should **omit** the top-level `tap_action` and just include the map options directly, e.g.
...
| up_action         | [Action](https://www.home-assistant.io/dashboards/actions/) |                                              | The Home Assistant action to perform on a swipe up.                                                                                                                                                                                                                                                                                               |
| down_action       | [Action](https://www.home-assistant.io/dashboards/actions/) |                                              | The Home Assistant action to perform on a swipe down.                                                                                                                                                                                                                                                                                             |
| left_action       | [Action](https://www.home-assistant.io/dashboards/actions/) |                                              | The Home Assistant action to perform on a swipe left.                                                                                                                                                                                                                                                                                             |
| right_action      | [Action](https://www.home-assistant.io/dashboards/actions/) |                                              | The Home Assistant action to perform on a swipe right.                                                                                                                                                                                                                                                                                            |
| tap_action        | [Action](https://www.home-assistant.io/dashboards/actions/) |                                              | The Home Assistant action to perform on a single tap.                                                                                                                                                                                                                                                                                             |
| double_tap_action | [Action](https://www.home-assistant.io/dashboards/actions/) |                                              | The Home Assistant action to perform on a double tap.                                                                                                                                                                                                                                                                                             |
...
| repeat            | number \| [Repeat](#repeat)                                 |                                              | The interval (in ms) to repeat actions, or (for more granular control), use the [Repeat](#repeat) config. <br/></br>**Note:** corner buttons do **not** repeat currently.                                                                                                                                                                         |
| visual_feedback   | [VisualFeedback](#visualfeedback)                           |                                              | Shows visual feedback when performing a gesture. See config for [VisualFeedback](#visualfeedback) for customization options                                                                                                                                                                                                                       |

#### Corners:

| Name         | Type              | Description                                           |
| ------------ | ----------------- | ----------------------------------------------------- |
| top_left     | [Corner](#corner) | The configuration for the top left corner button.     |
| top_right    | [Corner](#corner) | The configuration for the top right corner button.    |
| bottom_left  | [Corner](#corner) | The configuration for the bottom left corner button.  |
| bottom_right | [Corner](#corner) | The configuration for the bottom right corner button. |
...
| hass_action | [Action](https://www.home-assistant.io/dashboards/actions/) | The Home Assistant action to perform when tapping the button.                                  |

#### Repeat:

| Name     | Type   | Description                                                                                                                                                             |
| -------- | ------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| interval | number | The time (in ms) between subsequent firings of the action. E.g. a value of `1000` will fire every second.                                                               |
| delay    | number | The **initial** delay (in ms) before the first action will fire **after reaching the threshold**. If omitted, the action will fire as soon as the threshold is reached. |
